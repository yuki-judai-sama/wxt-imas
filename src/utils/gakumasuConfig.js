...
export const DEFAULT_MEMBERS= 'TsukimuraTemari';
export const IMAGE_URL = 'gakumasu/';
export const HEAD_IMAGE_PREFIX = 'headImage-';
export const APP_NAME= '学マス';
export const LOGO= '学マス-logo.png'
export const TITLE= '学マス-title.png'